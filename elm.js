...
var _user$project$Types$GameConfig = F4(
	function (a, b, c, d) {
		return {width: a, height: b, fps: c, segmentDim: d};
	});
var _user$project$Types$Player = F4(
	function (a, b, c, d) {
		return {color: a, pos: b, direction: c, path: d};
	});
var _user$project$Types$Controls = F4(
	function (a, b, c, d) {
...
var _user$project$Types$PlayerBWins = {ctor: 'PlayerBWins'};
var _user$project$Types$PlayerAWins = {ctor: 'PlayerAWins'};
var _user$project$Types$Ended = F3(
	function (a, b, c) {
		return {ctor: 'Ended', _0: a, _1: b, _2: c};
	});
var _user$project$Types$Started = F2(
	function (a, b) {
		return {ctor: 'Started', _0: a, _1: b};
	});
var _user$project$Types$NotStarted = {ctor: 'NotStarted'};

var _user$project$State$headOnCollission = F2(
	function (player, other) {
		return _elm_lang$core$Native_Utils.eq(player.pos, other.pos);
	});
var _user$project$State$hitThePath = F2(
	function (player, other) {
		return A2(
			_elm_lang$core$List$any,
			F2(
...
var _user$project$State$hitTheWalls = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p6 = _p2.width;
		var _p5 = _p2.height;
		...
		return (_elm_lang$core$Native_Utils.cmp(
			...
			_elm_lang$core$Basics$toFloat(_p6) / 2) > 0) || ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$snd(_p4),
			_elm_lang$core$Basics$toFloat(_p5) / 2) > 0) || ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$fst(_p4),
			_elm_lang$core$Basics$toFloat(_p6) / -2) < 0) || (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$snd(_p4),
			_elm_lang$core$Basics$toFloat(_p5) / -2) < 0)));
	});
var _user$project$State$evaluate = F3(
	function (gameConfig, playerA, playerB) {
		return (A2(_user$project$State$hitTheWalls, gameConfig, playerA) || A2(_user$project$State$hitThePath, playerA, playerB)) ? _elm_lang$core$Maybe$Just(_user$project$Types$PlayerBWins) : ((A2(_user$project$State$hitTheWalls, gameConfig, playerB) || A2(_user$project$State$hitThePath, playerB, playerA)) ? _elm_lang$core$Maybe$Just(_user$project$Types$PlayerAWins) : (A2(_user$project$State$headOnCollission, playerA, playerB) ? _elm_lang$core$Maybe$Just(_user$project$Types$Draw) : _elm_lang$core$Maybe$Nothing));
	});
var _user$project$State$getNewSegment = F3(
	function (_p8, _p7, direction) {
		var _p9 = _p8;
		var _p14 = _p9.segmentDim;
		var _p10 = _p7;
		var _p13 = _p10._1;
		var _p12 = _p10._0;
		var _p11 = direction;
		switch (_p11.ctor) {
			case 'Up':
				return {ctor: '_Tuple2', _0: _p12, _1: _p13 + _p14};
			case 'Down':
				return {ctor: '_Tuple2', _0: _p12, _1: _p13 - _p14};
			case 'Left':
				return {ctor: '_Tuple2', _0: _p12 - _p14, _1: _p13};
			default:
				return {ctor: '_Tuple2', _0: _p12 + _p14, _1: _p13};
		}
	});
var _user$project$State$step = F2(
	function (gameConfig, player) {
		var newPath = A2(_elm_lang$core$List_ops['::'], player.pos, player.path);
		var newPos = A3(_user$project$State$getNewSegment, gameConfig, player.pos, player.direction);
		return _elm_lang$core$Native_Utils.update(
			player,
			{pos: newPos, path: newPath});
	});
var _user$project$State$getNewDirection = F3(
	function (controls, keyCode, currentDir) {
		var _p15 = function () {
			var key = _elm_lang$core$Char$fromCode(keyCode);
			return _elm_lang$core$Native_Utils.eq(key, controls.left) ? {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_List.fromArray(
					[_user$project$Types$Up, _user$project$Types$Down]),
				_1: _user$project$Types$Left
			} : (_elm_lang$core$Native_Utils.eq(key, controls.up) ? {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_List.fromArray(
					[_user$project$Types$Left, _user$project$Types$Right]),
				_1: _user$project$Types$Up
			} : (_elm_lang$core$Native_Utils.eq(key, controls.right) ? {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_List.fromArray(
					[_user$project$Types$Up, _user$project$Types$Down]),
				_1: _user$project$Types$Right
			} : (_elm_lang$core$Native_Utils.eq(key, controls.down) ? {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_List.fromArray(
					[_user$project$Types$Left, _user$project$Types$Right]),
				_1: _user$project$Types$Down
			} : {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_List.fromArray(
					[]),
...
var _user$project$State$changeDirection = F3(
	function (player, controls, keyCode) {
		var newDir = A3(_user$project$State$getNewDirection, controls, keyCode, player.direction);
		return _elm_lang$core$Native_Utils.update(
			player,
			{direction: newDir});
	});
var _user$project$State$pos = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$State$initPlayerB = function (_p16) {
	var _p17 = _p16;
	return {
		color: _elm_lang$core$Color$blue,
		pos: A2(
			_user$project$State$pos,
			_elm_lang$core$Basics$toFloat(_p17.width) / 2.0,
			0),
		direction: _user$project$Types$Left,
		path: _elm_lang$core$Native_List.fromArray(
			[])
	};
};
var _user$project$State$initPlayerA = function (_p18) {
	var _p19 = _p18;
	return {
		color: _elm_lang$core$Color$yellow,
		pos: A2(
			_user$project$State$pos,
			_elm_lang$core$Basics$toFloat(_p19.width) / -2.0,
			0),
		direction: _user$project$Types$Right,
		path: _elm_lang$core$Native_List.fromArray(
			[])
	};
};

var _user$project$View$drawPlayer = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p4 = _p2.segmentDim;
		var _p3 = _p0;
		var head = A2(
			...
			A2(
				...
				A2(_evancz$elm_graphics$Collage$rect, _p4 * 2, _p4 * 2)));
		var tail = A2(
			_elm_lang$core$List$map,
			function (pos) {
				return A2(
					...
					A2(
						_evancz$elm_graphics$Collage$filled,
						_p3.color,
						A2(_evancz$elm_graphics$Collage$rect, _p4, _p4)));
			},
			_p3.path);
		return A2(_elm_lang$core$List_ops['::'], head, tail);
	});
var _user$project$View$draw = F2(
	function (gameConfig, players) {
		return A2(
			_elm_lang$core$List$concatMap,
			_user$project$View$drawPlayer(gameConfig),
			players);
	});
var _user$project$View$txt = function (msg) {
...
var _user$project$View$view = F2(
	function (gameConfig, model) {
		var content = function () {
			...
			switch (_p5.ctor) {
				case 'NotStarted':
					...
					return _elm_lang$core$Native_List.fromArray(
						[
							_user$project$View$txt(msg)
						]);
				case 'Started':
					return A2(
						_user$project$View$draw,
						gameConfig,
						_elm_lang$core$Native_List.fromArray(
							[_p5._0, _p5._1]));
				default:
					var outcomeMsg = function () {
						var _p6 = _p5._0;
						switch (_p6.ctor) {
							case 'Draw':
								return 'it\'s a DRAW';
					...
					var msg = A2(_elm_lang$core$Basics_ops['++'], outcomeMsg, '\npress SPACE to restart');
					return A2(
						_elm_lang$core$Basics_ops['++'],
						A2(
							_user$project$View$draw,
		...
		var _p7 = {ctor: '_Tuple2', _0: gameConfig.width, _1: gameConfig.height};
		var width = _p7._0;
		var height = _p7._1;
		var bg = A2(
			_evancz$elm_graphics$Collage$filled,
...
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Types$NotStarted, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$playerBControls = {
	up: _elm_lang$core$Native_Utils.chr('i'),
	down: _elm_lang$core$Native_Utils.chr('k'),
	left: _elm_lang$core$Native_Utils.chr('j'),
	right: _elm_lang$core$Native_Utils.chr('l')
};
var _user$project$Main$playerAControls = {
	up: _elm_lang$core$Native_Utils.chr('w'),
	down: _elm_lang$core$Native_Utils.chr('s'),
	left: _elm_lang$core$Native_Utils.chr('a'),
	right: _elm_lang$core$Native_Utils.chr('d')
};
var _user$project$Main$gameConfig = {width: 600, height: 600, fps: 50, segmentDim: 3};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'NotStarted':
				var _p1 = msg;
				if ((_p1.ctor === 'KeyPress') && (_p1._0 === 32)) {
					var playerB = _user$project$State$initPlayerB(_user$project$Main$gameConfig);
					var playerA = _user$project$State$initPlayerA(_user$project$Main$gameConfig);
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Types$Started, playerA, playerB),
			...
			case 'Started':
				...
				var _p5 = _p0._0;
				var _p2 = msg;
				if (_p2.ctor === 'KeyPress') {
					var _p3 = _p2._0;
					var newPlayerB = A3(_user$project$State$changeDirection, _p6, _user$project$Main$playerBControls, _p3);
					var newPlayerA = A3(_user$project$State$changeDirection, _p5, _user$project$Main$playerAControls, _p3);
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Types$Started, newPlayerA, newPlayerB),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var newPlayerB = A2(_user$project$State$step, _user$project$Main$gameConfig, _p6);
					var newPlayerA = A2(_user$project$State$step, _user$project$Main$gameConfig, _p5);
					var outcome = A3(_user$project$State$evaluate, _user$project$Main$gameConfig, newPlayerA, newPlayerB);
					var _p4 = outcome;
					if (_p4.ctor === 'Just') {
						return {
							ctor: '_Tuple2',
							_0: A3(_user$project$Types$Ended, _p4._0, newPlayerA, newPlayerB),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {
			...
			default:
				var _p7 = msg;
				if ((_p7.ctor === 'KeyPress') && (_p7._0 === 32)) {
					var playerB = _user$project$State$initPlayerB(_user$project$Main$gameConfig);
					var playerA = _user$project$State$initPlayerA(_user$project$Main$gameConfig);
					return {
						ctor: '_Tuple2',
			...
			return _elm_lang$core$Platform_Sub$batch(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(
						_elm_lang$core$Time$every,
						_elm_lang$core$Time$inMilliseconds(1000 / _user$project$Main$gameConfig.fps),
	...
	main: _elm_lang$html$Html_App$program(
		{
			...
			view: _user$project$View$view(_user$project$Main$gameConfig),
